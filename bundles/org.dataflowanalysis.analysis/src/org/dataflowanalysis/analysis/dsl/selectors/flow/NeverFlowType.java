...
public class NeverFlowType extends AbstractFlowType {
    private static final Logger logger = LoggerManager.getLogger(NeverFlowType.class);

    public NeverFlowType(AbstractSelector sourceSelector, AbstractSelector destinationSelector,
