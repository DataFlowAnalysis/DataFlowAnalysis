...
public class BaseTest {
  ...
  public void initializeOnlineShopAnalysis() {
    ...
    final var nodeCharacteristicsPath =
        Paths.get("models", "BranchingOnlineShop", "default.nodecharacteristics");
  ...
  public void initializeInternationalOnlineShopAnalysis() {
    ...
    final var nodeCharacteristicsPath =
        Paths.get("models", "InternationalOnlineShop", "default.nodecharacteristics");
  ...
  public void initializeTravelPlannerAnalysis() {
    ...
    final var nodeCharacteristicsPath =
        Paths.get("models", "TravelPlanner", "travelPlanner.nodecharacteristics");

    travelPlannerAnalysis =
        this.initializeAnalysis(usageModelPath, allocationPath, nodeCharacteristicsPath);
    travelPlannerAnalysis.initializeAnalysis();
    travelPlannerAnalysis.setLoggerLevel(Level.TRACE);
  }

  protected PCMDataFlowConfidentialityAnalysis initializeAnalysis(
      Path usagePath, Path allocationPath, Path nodePath) {
    PCMDataFlowConfidentialityAnalysis analysis =
        new PCMDataFlowConfidentialityAnalysisBuilder()
            .standalone()
