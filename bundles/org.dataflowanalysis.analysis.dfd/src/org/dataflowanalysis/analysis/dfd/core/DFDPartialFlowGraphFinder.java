			...
			for (var flow : flows) {
				if (flow.getDestinationPin().equals(inputPin)) {
					for (var vertex : vertices) {
						...
						List<DFDVertex> previousNodeVertices = buildRec(new DFDVertex(previousNode.getEntityName(), previousNode, new HashMap<>(), new HashMap<>()), flows, previousNodeInputPins);
