...
public class ActionSequenceFinderTest extends BaseTest {
    ...
    public void testTravelPlannerCount() {
        ...
        assertEquals(ActionSequenceFinderPaths.travelPlannerPaths.size(), flowGraph.getTransposeFlowGraphs().size(),
                String.format("Expected two dataflow sequences, but found %s sequences", flowGraph.getTransposeFlowGraphs().size()));
        flowGraph.getTransposeFlowGraphs().forEach(logger::trace);
    }
    ...
    public void testInternationalOnlineShopCount() {
        ...
        assertEquals(ActionSequenceFinderPaths.internationalOnlineShopPaths.size(), flowGraph.getTransposeFlowGraphs().size(),
                String.format("Expected two dataflow sequences, but found %s sequences", flowGraph.getTransposeFlowGraphs().size()));
        flowGraph.getTransposeFlowGraphs().forEach(logger::trace);
    }
    ...
    public void testOnlineShopCount() {
        ...
        assertEquals(ActionSequenceFinderPaths.onlineShopPaths.size(), flowGraph.getTransposeFlowGraphs().size(),
                String.format("Expected two dataflow sequences, but found %s sequences", flowGraph.getTransposeFlowGraphs().size()));
        flowGraph.getTransposeFlowGraphs().forEach(logger::trace);
    }
    ...
    public void testTravelPlannerPath() {
        ...
        assertTrue(flowGraph.getTransposeFlowGraphs().size() >= ActionSequenceFinderPaths.travelPlannerPaths.size());

        for (int i = 0; i < ActionSequenceFinderPaths.travelPlannerPaths.size(); i++) {
            assertSequenceElements(flowGraph.getTransposeFlowGraphs().get(i), ActionSequenceFinderPaths.travelPlannerPaths.get(i));
        }
    }
    ...
    public void testInternationalOnlineShopPath() {
        ...
        assertTrue(flowGraph.getTransposeFlowGraphs().size() >= ActionSequenceFinderPaths.internationalOnlineShopPaths.size());

        for (int i = 0; i < ActionSequenceFinderPaths.internationalOnlineShopPaths.size(); i++) {
            assertSequenceElements(flowGraph.getTransposeFlowGraphs().get(i), ActionSequenceFinderPaths.internationalOnlineShopPaths.get(i));
        }
    }
    ...
    public void testOnlineShopPath() {
        ...
        assertTrue(flowGraph.getTransposeFlowGraphs().size() >= ActionSequenceFinderPaths.onlineShopPaths.size());

        for (int i = 0; i < ActionSequenceFinderPaths.onlineShopPaths.size(); i++) {
            assertSequenceElements(flowGraph.getTransposeFlowGraphs().get(i), ActionSequenceFinderPaths.onlineShopPaths.get(i));
        }
    }
    ...
    public void testTravelPlannerSEFFContent() {
        PCMFlowGraphCollection flowGraph = travelPlannerAnalysis.findFlowGraphs();
        assertSEFFSequenceElementContent(flowGraph.getTransposeFlowGraphs().get(0), 27, "ask airline to book flight");
    }
    ...
    public void testInternationalOnlineShopSEFFContent() {
        PCMFlowGraphCollection flowGraph = internationalOnlineShopAnalysis.findFlowGraphs();
        assertSEFFSequenceElementContent(flowGraph.getTransposeFlowGraphs().get(0), 17, "DatabaseStoreUserData");
    }
    ...
    public void testOnlineShopSEFFContent() {
        PCMFlowGraphCollection flowGraph = onlineShopAnalysis.findFlowGraphs();
        assertSEFFSequenceElementContent(flowGraph.getTransposeFlowGraphs().get(0), 3, "DatabaseLoadInventory");
    }
    ...
    public void testTravelPlannerUserContent() {
        PCMFlowGraphCollection flowGraph = travelPlannerAnalysis.findFlowGraphs();
        assertUserSequenceElementContent(flowGraph.getTransposeFlowGraphs().get(0), 5, "look for flights");
    }
    ...
    public void testInternationalOnlineShopUserContent() {
        PCMFlowGraphCollection flowGraph = internationalOnlineShopAnalysis.findFlowGraphs();
        assertUserSequenceElementContent(flowGraph.getTransposeFlowGraphs().get(0), 11, "BuyEntryLevelSystemCall");
    }
    ...
    public void testOnlineShopUserContent() {
        PCMFlowGraphCollection flowGraph = onlineShopAnalysis.findFlowGraphs();
        assertUserSequenceElementContent(flowGraph.getTransposeFlowGraphs().get(0), 1, "ViewEntryLevelSystemCall");
    }
}
