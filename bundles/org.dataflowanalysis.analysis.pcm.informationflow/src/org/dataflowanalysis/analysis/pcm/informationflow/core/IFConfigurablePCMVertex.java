...
/**
 * Defines configuration options for the extraction of label propagation functions of a vertex from the PCM.
 */
public interface IFConfigurablePCMVertex {
    ...
    /**
     * Specifies the extraction strategy for label propagation functions from VariableCharacterisations.
    ...
    /**
     * Returns the used extraction strategy for label propagation functions from VariableCharacterisations.
