    ...
    public List<ExpectedViolation> getExpectedViolations() {
        return List.of(
        		new ExpectedViolation(0, new DFDIdentifier("djba98"),
					...
					Map.of("l4xfbo", List.of(new ExpectedCharacteristic("Levels", "UserAirlineAgency")), 
							"70i8yq", List.of(new ExpectedCharacteristic("Levels", "UserAirline"), new ExpectedCharacteristic("Levels", "User")))),
