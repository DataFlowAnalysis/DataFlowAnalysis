...
public class FlowItemProvider extends EntityItemProvider {
    ...
    protected void addSourceNodePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(), getString("_UI_Flow_sourceNode_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Flow_sourceNode_feature", "_UI_Flow_type"),
                dataflowdiagramPackage.Literals.FLOW__SOURCE_NODE, true, false, true, null, null, null));
    }

    /**
     * This adds a property descriptor for the Destination Node feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected void addDestinationNodePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(), getString("_UI_Flow_destinationNode_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Flow_destinationNode_feature", "_UI_Flow_type"),
                dataflowdiagramPackage.Literals.FLOW__DESTINATION_NODE, true, false, true, null, null, null));
    }

    /**
     * This adds a property descriptor for the Destination Pin feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected void addDestinationPinPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(), getString("_UI_Flow_destinationPin_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Flow_destinationPin_feature", "_UI_Flow_type"),
                dataflowdiagramPackage.Literals.FLOW__DESTINATION_PIN, true, false, true, null, null, null));
    }

    /**
     * This adds a property descriptor for the Source Pin feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected void addSourcePinPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(), getString("_UI_Flow_sourcePin_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Flow_sourcePin_feature", "_UI_Flow_type"),
                dataflowdiagramPackage.Literals.FLOW__SOURCE_PIN, true, false, true, null, null, null));
    }

    /**
     * This returns Flow.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Flow_type") : getString("_UI_Flow_type") + " " + label;
    }
