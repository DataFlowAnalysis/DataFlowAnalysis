...
public class VertexNameSelectorTest {
    ...
    private static Stream<Arguments> correctVertexNameSelectors() {
        return Stream.of(Arguments.of("vertexName name", "name", true), Arguments.of("vertexName otherA.otherB", "otherA.otherB", true),
                Arguments.of("vertexName some string with spaces", "some", false), Arguments.of("vertexName contains name", "name", true));
    }

    private static Stream<Arguments> incorrectVertexNameSelectors() {
        return Stream.of(Arguments.of("vertexName"), Arguments.of(""), Arguments.of("vertexName "), Arguments.of("vertexName contains"),
                Arguments.of("vertexName contains "));
    }
}
