...
/**
 * A vertex for the evaluation of information flows. In comparison to {@link CallingUserPCMVertex}
...
public abstract class AbstractIFCallingUserPCMVertex extends CallingUserPCMVertex implements IFConfigurablePCMVertex {
     ...
     * AbstractIFSEFFPCMVertex. Changes in this class may require changes in the named classes.
     */
    ...
    /**
     * As for a {@link CallingUserPCMVertex} the vertex has an underlying {@link EntryLevelSystemCall} SEFF element which
     * influences the behavior through defined VariableCharacterisations. The vertex can have {@code previousElements} from
     * which the incoming DataFlowVariables are received. Furthermore, the vertex contains a {@link ResourceProvider}.
     * Lastly, the vertex might consider implicit flow and requires an {@link IFPCMExtractionStrategy} to define how label
     * propagation functions are extracted.
     ...
     */
    public AbstractIFCallingUserPCMVertex(EntryLevelSystemCall element, List<? extends AbstractPCMVertex<?>> previousElements, boolean isCalling,
    ...
    public AbstractPCMVertex<?> deepCopy(Map<AbstractPCMVertex<?>, AbstractPCMVertex<?>> isomorphism) {
        ...
        AbstractIFCallingUserPCMVertex copy = createIFUserVertex(getReferencedElement(), List.copyOf(previousElements), resourceProvider,
     ...
     * @see #AbstractIFCallingUserPCMVertex(EntryLevelSystemCall, List, boolean, ResourceProvider, boolean,
     * IFPCMExtractionStrategy)
     */
    protected abstract AbstractIFCallingUserPCMVertex createIFUserVertex(EntryLevelSystemCall element,
            List<? extends AbstractPCMVertex<?>> previousElements, ResourceProvider resourceProvider, boolean considerImplicitFlow,
