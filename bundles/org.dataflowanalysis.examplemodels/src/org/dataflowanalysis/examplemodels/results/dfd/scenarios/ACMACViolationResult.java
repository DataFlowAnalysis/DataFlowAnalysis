...
public class ACMACViolationResult implements DFDExampleModelResult {
    ...
    public List<ExpectedViolation> getExpectedViolations() {
        return List.of(
                new ExpectedViolation(2, new DFDIdentifier("6xeidb"),
                        List.of(new ExpectedCharacteristic("ClearanceLevel", "Classified")),
                        Map.of("m1fco", List.of(new ExpectedCharacteristic("ClassificationLevel", "Classified")),
                                "3vt6d", List.of(new ExpectedCharacteristic("ClassificationLevel", "Secret")), "5bphw9",
                ...
                new ExpectedViolation(2, new DFDIdentifier("g00dna"),
                        List.of(new ExpectedCharacteristic("ClearanceLevel", "Classified")),
