...
public class IFLatticeUtils {
    ...
    /**
     * Returns if the first Literal is a lower level in the lattice than the second Literal. Assumes both Literals to be of
     * the same lattice. Assumes the lattice to be ordered from lowest to highest.
    ...
    /**
     * Returns if the first Literal is a higher level in the lattice than the second Literal. Assumes both Literals to be of
     * the same lattice. Assumes the lattice to be ordered from lowest to highest.
     * @param first the first Literal
     * @param second the second Literal
    ...
    /**
     * Compares the first Literal with the second Literal in the lattice. The result is negative if the first Literal is of
     * a lower level, zero if the literals are of the same level and positive if the first Literal is of a lower level.
     * Assumes both Literals to be of the same lattice. Assumes the lattice to be ordered from lowest to highest.
     * @param first the first Literal
     * @param second the second Literal
    ...
    public static int compareLevels(Literal first, Literal second) {
        ...
        int firstIndex = enumeration.getLiterals()
                .indexOf(first);
        int secondIndex = enumeration.getLiterals()
                .indexOf(second);
