...
public class SetAssignmentItemProvider extends AbstractAssignmentItemProvider {
    ...
    protected void addOutputLabelsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(), getString("_UI_SetAssignment_outputLabels_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_SetAssignment_outputLabels_feature", "_UI_SetAssignment_type"),
                datadictionaryPackage.Literals.SET_ASSIGNMENT__OUTPUT_LABELS, true, false, true, null, null, null));
    }

    /**
     * This returns SetAssignment.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SetAssignment_type") : getString("_UI_SetAssignment_type") + " " + label;
    }
