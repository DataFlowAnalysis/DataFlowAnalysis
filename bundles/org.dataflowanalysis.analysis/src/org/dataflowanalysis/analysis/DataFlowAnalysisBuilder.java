...
/**
 * This class represents a basic builder for a {@link DataFlowConfidentialityAnalysis}.
 * A concrete subclass of the builder must implement the {@link DataFlowAnalysisBuilder#build()} method and return a valid {@link DataFlowConfidentialityAnalysis} or one of its subclasses.
 * The data contained in this builder can be accessed in subclasses and validated via {@link DataFlowAnalysisBuilder#validate()}.
 *
 */
