...
public class ActionSequenceFinderTest extends BaseTest {
    ...
    public void testTravelPlannerCount() {
        ...
        flowGraph.getTransposedFlowGraphs().forEach(logger::trace);
    }
    ...
    public void testTravelPlannerPath() {
        ...
        for (int i = 0; i < ActionSequenceFinderPaths.travelPlannerPaths.size(); i++) {
            assertSequenceElements(flowGraph.getTransposedFlowGraphs().get(i), ActionSequenceFinderPaths.travelPlannerPaths.get(i));
        }
    }
    ...
    public void testInternationalOnlineShopPath() {
        ...
        for (int i = 0; i < ActionSequenceFinderPaths.internationalOnlineShopPaths.size(); i++) {
            assertSequenceElements(flowGraph.getTransposedFlowGraphs().get(i), ActionSequenceFinderPaths.internationalOnlineShopPaths.get(i));
        }
    }
    ...
    public void testOnlineShopPath() {
        ...
        for (int i = 0; i < ActionSequenceFinderPaths.onlineShopPaths.size(); i++) {
            assertSequenceElements(flowGraph.getTransposedFlowGraphs().get(i), ActionSequenceFinderPaths.onlineShopPaths.get(i));
        }
    }
