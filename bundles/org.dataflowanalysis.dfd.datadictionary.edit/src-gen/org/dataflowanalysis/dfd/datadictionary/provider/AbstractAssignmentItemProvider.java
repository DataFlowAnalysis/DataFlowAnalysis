...
public class AbstractAssignmentItemProvider extends EntityItemProvider {
    ...
    /**
     * This adds a property descriptor for the Output Pin feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected void addOutputPinPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(), getString("_UI_AbstractAssignment_outputPin_feature"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_AbstractAssignment_type")
