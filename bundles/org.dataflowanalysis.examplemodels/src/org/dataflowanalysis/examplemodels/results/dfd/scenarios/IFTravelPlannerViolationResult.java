...
public class IFTravelPlannerViolationResult implements DFDExampleModelResult {
    ...
    public List<ExpectedViolation> getExpectedViolations() {
        return List.of(
                new ExpectedViolation(2, new DFDIdentifier("djba98"), List.of(new ExpectedCharacteristic("ClearanceLevel", "UserAirline")),
                        Map.of("l4xfbo", List.of(new ExpectedCharacteristic("ClassificationLevel", "UserAirlineAgency")), "70i8yq",
                                List.of(new ExpectedCharacteristic("ClassificationLevel", "UserAirline"),
                                        new ExpectedCharacteristic("ClassificationLevel", "User")))),
                new ExpectedViolation(2, new DFDIdentifier("pnz9vg"), List.of(new ExpectedCharacteristic("ClearanceLevel", "UserAirline")),
                        Map.of("u32kc",
