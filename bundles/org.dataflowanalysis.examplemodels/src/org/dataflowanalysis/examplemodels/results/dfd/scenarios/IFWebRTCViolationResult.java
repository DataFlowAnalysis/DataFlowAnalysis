...
public class IFWebRTCViolationResult implements DFDExampleModelResult {
    ...
    public List<ExpectedViolation> getExpectedViolations() {
        return List.of(
        		new ExpectedViolation(2, new DFDIdentifier("ni7d7"), 
        				List.of(new ExpectedCharacteristic("Zone", "Attack")), Map.of(
        						"d3bsd", List.of(new ExpectedCharacteristic("Level", "High"), new ExpectedCharacteristic("Level", "Low")))),
        		new ExpectedViolation(5, new DFDIdentifier("ni7d7"), 
        				List.of(new ExpectedCharacteristic("Zone", "Attack")), Map.of(
        						"d3bsd", List.of(new ExpectedCharacteristic("Level", "High"), new ExpectedCharacteristic("Level", "Low")), 
        						"hxzuok", List.of(new ExpectedCharacteristic("Level", "High"), 
        								new ExpectedCharacteristic("Level", "Low"), new ExpectedCharacteristic("ContainedClassification", "High")))));
    }
    /**
