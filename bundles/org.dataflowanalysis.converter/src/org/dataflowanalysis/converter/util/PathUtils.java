...
public class PathUtils {
    /**
     * Normalizes the given path string by removing quotes and adding the correct extension,
     * if the input does not have a normalized path string
    ...
    public static String normalizePathString(String input, String extension) {
        ...
        if (!input.endsWith(extension)) input = input + extension;
        return input;
    }
}
