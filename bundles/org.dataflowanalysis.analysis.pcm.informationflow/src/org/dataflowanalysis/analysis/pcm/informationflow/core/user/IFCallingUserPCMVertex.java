...
/**
 * An concrete implementation of {@link AbstractIFCallingUserPCMVertex} for calling behavior.
 */
public class IFCallingUserPCMVertex extends AbstractIFCallingUserPCMVertex {
    ...
    protected List<VariableCharacterisation> extractVariableCharacterisations() {
        return getReferencedElement().getInputParameterUsages_EntryLevelSystemCall()
                .stream()
