		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_outputLabels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_outputLabels_feature", "_UI_Assignment_type"),
				 datadictionaryPackage.Literals.ASSIGNMENT__OUTPUT_LABELS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(datadictionaryPackage.Literals.ASSIGNMENT__TERM,
