...
## ⚠️ Constraints
- Sensitive data from the user such as ConsentSettings (old or new), AcceptedPaper, ReviewedPaper, CandidateReviewers, Manuscripts, and Purpose can not flow to an insecure node:
...
- AcceptedPaper data neverflows to a vertex without the consented purpose of RecommendPapers or ViewPaper:
