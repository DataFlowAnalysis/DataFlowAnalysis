    ...
    public List<AnalysisConstraint> getDSLConstraints() {
        return List.of(new ConstraintDSL().ofData()
                ...
                new ConstraintDSL().ofData()
                        ...
                        .where()
                        .isEmpty(Intersection.of(ConstraintVariable.of("OriginLocation"),
                                ConstraintVariable.of("DestinationLocation")))
                        .create());
    }
    ...
    public List<ExpectedViolation> getExpectedViolations() {
        return List.of(
                new ExpectedViolation(0, PCMIdentifier.of("_NTFQ0D6xEeuVUal8mM_jUA", false),
                        List.of(new ExpectedCharacteristic("Location", "USA"),
                                new ExpectedCharacteristic("Role", "Clerk")),
                        Map.of("RETURN", List.of(new ExpectedCharacteristic("Status", "Celebrity")), "customerName",
                                List.of(new ExpectedCharacteristic("Status", "Regular"),
                                        new ExpectedCharacteristic("Origin", "USA")),
                                "customer",
                                List.of(new ExpectedCharacteristic("Status", "Regular"),
                                        new ExpectedCharacteristic("Origin", "USA")))),
                new ExpectedViolation(0, PCMIdentifier.of("_KU1XAD6xEeuVUal8mM_jUA", true),
                        List.of(new ExpectedCharacteristic("Location", "USA"),
                                new ExpectedCharacteristic("Role", "Clerk")),
                        Map.of("customerName",
                                List.of(ExpectedCharacteristic.of("Origin", "USA"),
                                        ExpectedCharacteristic.of("Status", "Regular")),
                ...
                new ExpectedViolation(2, PCMIdentifier.of("_JD3o8D6yEeuVUal8mM_jUA", false),
                        List.of(new ExpectedCharacteristic("Location", "Asia"),
                                new ExpectedCharacteristic("Role", "Clerk")),
                        Map.of("RETURN", List.of(new ExpectedCharacteristic("Status", "Celebrity")), "customerName",
                                List.of(new ExpectedCharacteristic("Status", "Regular"),
                                        new ExpectedCharacteristic("Origin", "Asia")),
                                "customer",
                                List.of(new ExpectedCharacteristic("Status", "Regular"),
                                        new ExpectedCharacteristic("Origin", "Asia")))),
                new ExpectedViolation(2, PCMIdentifier.of("_LxynwD6yEeuVUal8mM_jUA", true),
                        List.of(new ExpectedCharacteristic("Location", "Asia"),
                                new ExpectedCharacteristic("Role", "Clerk")),
                        Map.of("customerName",
                                List.of(ExpectedCharacteristic.of("Origin", "Asia"),
                                        ExpectedCharacteristic.of("Status", "Regular")),
                                "customer", List.of(ExpectedCharacteristic.of("Status", "Celebrity")))),
