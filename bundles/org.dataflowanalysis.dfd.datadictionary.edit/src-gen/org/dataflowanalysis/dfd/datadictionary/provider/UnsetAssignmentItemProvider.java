...
public class UnsetAssignmentItemProvider extends AbstractAssignmentItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnsetAssignment_outputLabels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnsetAssignment_outputLabels_feature", "_UI_UnsetAssignment_type"),
				 datadictionaryPackage.Literals.UNSET_ASSIGNMENT__OUTPUT_LABELS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UnsetAssignment.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UnsetAssignment_type") :
