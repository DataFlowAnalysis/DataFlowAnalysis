...
public class PCMCharacteristicsTest {
    private static Stream<Arguments> getValidPCMCharacteristics() {
        return Stream.of(Arguments.of("Location", "EU", "Location.EU"), Arguments.of("Location", "nonEU", "Location.nonEU"),
                Arguments.of("Encrypted", "true", "Encrypted.true"));
    }

    private static Stream<Arguments> getInvalidPCMCharacteristics() {
        return Stream.of(Arguments.of("Location", ""), Arguments.of("", "nonEU"), Arguments.of("", ""), Arguments.of(null, null),
    ...
    public void shouldParsePCMCharacteristics(String characteristicTypeName, String characteristicValueName) {
        PCMCharacteristicValue characteristicValue = new PCMCharacteristicValue(this.getCharacteristicType(characteristicTypeName),
    ...
    public void shouldNotParsePCMCharacteristics(String characteristicTypeName, String characteristicValueName) {
        assertThrows(IllegalArgumentException.class,
                () -> new PCMCharacteristicValue(this.getCharacteristicType(characteristicTypeName), this.getLiteral(characteristicValueName)),
