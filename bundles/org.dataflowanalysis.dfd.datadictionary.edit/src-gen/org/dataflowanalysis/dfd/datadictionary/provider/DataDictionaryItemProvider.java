...
public class DataDictionaryItemProvider extends EntityItemProvider {
    ...
    /**
     * This returns DataDictionary.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DataDictionary_type") : getString("_UI_DataDictionary_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(
                createChildParameter(datadictionaryPackage.Literals.DATA_DICTIONARY__LABEL_TYPES, datadictionaryFactory.eINSTANCE.createLabelType()));

        newChildDescriptors.add(
                createChildParameter(datadictionaryPackage.Literals.DATA_DICTIONARY__BEHAVIOR, datadictionaryFactory.eINSTANCE.createBehavior()));
    }
