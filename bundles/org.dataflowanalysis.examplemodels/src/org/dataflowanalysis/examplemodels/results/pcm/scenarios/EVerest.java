        ...
        return List.of(
                ...
                new ExpectedViolation(13, PCMIdentifier.of("_LUBEYEWtEe-vaMxYiHuBmw"),
                        ...
                        Map.of("reservation_id",
                                List.of(new ExpectedCharacteristic("ActorStatus", "Authorized"), new ExpectedCharacteristic("Status", "Sensitive"),
                                        new ExpectedCharacteristic("Status", "Anonymized")))),
                new ExpectedViolation(13, PCMIdentifier.of("_s31PoTOhEe-thK3JRY5OhA"),
                        List.of(new ExpectedCharacteristic("Location", "ChargingStation")),
                        Map.of("reservation_id",
                                List.of(new ExpectedCharacteristic("Status", "Sensitive"), new ExpectedCharacteristic("Status", "Anonymized"),
                                        new ExpectedCharacteristic("ActorStatus", "Authorized")))),
                new ExpectedViolation(13, PCMIdentifier.of("_mf_04EWqEe-vaMxYiHuBmw"),
                        List.of(new ExpectedCharacteristic("Location", "ChargingStation")),
                        Map.of("reservation_id",
                                List.of(new ExpectedCharacteristic("Status", "Sensitive"), new ExpectedCharacteristic("Status", "Anonymized"),
                                        new ExpectedCharacteristic("ActorStatus", "Authorized")))),
                ...
                new ExpectedViolation(14, PCMIdentifier.of("_zRGngU0LEe-j2Yo8i_9OIA"),
                        ...
                        Map.of("msg", List.of(new ExpectedCharacteristic("ActorStatus", "Authorized")), "request",
                                List.of(new ExpectedCharacteristic("ActorStatus", "Authorized")), "RETURN",
                                List.of(new ExpectedCharacteristic("Status", "Signed"), new ExpectedCharacteristic("Status", "Firmware")), "firmware",
                ...
                new ExpectedViolation(14, PCMIdentifier.of("_92x60U0NEe-j2Yo8i_9OIA"),
                        ...
                        Map.of("request", List.of(new ExpectedCharacteristic("ActorStatus", "Authorized")), "firmwareFile",
                                ...
                                List.of(new ExpectedCharacteristic("Status", "Signed"), new ExpectedCharacteristic("Status", "Firmware")))),
                new ExpectedViolation(14, PCMIdentifier.of("_OKY0YE9MEe-bbuz8MX_WSQ"),
                        List.of(new ExpectedCharacteristic("Actor", "Engineer"), new ExpectedCharacteristic("ActorStatus", "Authorized")),
                        Map.of("msg", List.of(new ExpectedCharacteristic("ActorStatus", "Authorized")), "RETURN",
                                List.of(new ExpectedCharacteristic("Status", "Signed"), new ExpectedCharacteristic("Status", "Firmware")))),
                new ExpectedViolation(14, PCMIdentifier.of("_j9D_cFBfEfGEa-snus0hcw"),
                        List.of(new ExpectedCharacteristic("Location", "ChargingStation")),
                        Map.of("msg", List.of(new ExpectedCharacteristic("ActorStatus", "Authorized")), "request",
                                List.of(new ExpectedCharacteristic("ActorStatus", "Authorized")), "firmware",
                                List.of(new ExpectedCharacteristic("Status", "Signed"), new ExpectedCharacteristic("Status", "Firmware")))),
