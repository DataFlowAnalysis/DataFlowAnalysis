...
public class CallingUserPCMVertex extends UserPCMVertex<EntryLevelSystemCall>
  ...
  public void evaluateDataFlow() {
    ...
    if (this.isCalling()) {
      super.checkCallParameter(
          super.getReferencedElement().getOperationSignature__EntryLevelSystemCall(),
    ...
    if (this.isReturning()) {
      outgoingDataFlowVariables =
          outgoingDataFlowVariables.stream()
  ...
  public String toString() {
    ...
    return String.format(
        ...
        calling,
        this.getReferencedElement().getEntityName(),
  ...
  public AbstractPCMVertex<?> deepCopy(
    ...
    CallingUserPCMVertex copy =
        new CallingUserPCMVertex(referencedElement, List.of(), isCalling, resourceProvider);
    if (this.isEvaluated()) {
