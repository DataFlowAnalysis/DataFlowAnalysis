...
public class PCMDataFlowVariableTest {
    ...
    private static Stream<Arguments> getValidPCMDataFlowVariables() {
        return Stream.of(Arguments.of("ccd", "Location", "EU", "ccd.[Location.EU]"),
    ...
    public void shouldParse(String variableName, String characteristicType, String characteristicValue) {
        ...
        assertEquals(characteristicType, dataCharacteristic.getAllCharacteristics()
                .get(0)
                .getTypeName(), "Characteristic Type should parse correctly");
        assertEquals(characteristicValue, dataCharacteristic.getAllCharacteristics()
                .get(0)
                .getValueName(), "Characteristic Value should parse correctly");
    }
    ...
    public void shouldFindCorrectly(String variableName, String characteristicType, String characteristicValue) {
        ...
        assertEquals(characteristicValue, result.get(0)
                .getValueName(), "Should find correct characteristic value with type");
    }
