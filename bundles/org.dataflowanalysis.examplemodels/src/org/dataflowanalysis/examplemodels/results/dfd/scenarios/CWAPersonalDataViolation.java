...
public class CWAPersonalDataViolation implements DFDExampleModelResult {
    ...
    public List<ExpectedViolation> getExpectedViolations() {
        return List.of(
                new ExpectedViolation(1, new DFDIdentifier("u0us6m"),
                        List.of(new ExpectedCharacteristic("Server", "CWApp")),
                        Map.of("11t5gm", List.of(new ExpectedCharacteristic("TestResults", "PCRTestResultsPositive")),
                                "owhnd8", List.of(new ExpectedCharacteristic("Identifiers", "PersonalData")), "p30m2t",
                ...
                new ExpectedViolation(4, new DFDIdentifier("oz1nrf"),
                        List.of(new ExpectedCharacteristic("Server", "VerificationServer"),
                                new ExpectedCharacteristic("Cloud", "OTC")),
                        Map.of("wthws6", List.of(), "uqry3y",
                                List.of(new ExpectedCharacteristic("TestResults", "PCRTestResultsPositive")), "rly6k",
