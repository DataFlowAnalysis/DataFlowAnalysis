...
public class ConstraintTest extends BaseTest {
    ...
    /**
     * Prints detailed information of a node with its data and vertex characteristics. The information is printed using
     * the logger's trace function.
     ...
     * @return Returns a String with the vertex's string representation and a list of all related characteristics types
     * and literals
     */
    protected String createPrintableNodeInformation(AbstractVertex<?> node) {
        ...
        return String.format(template, node, System.lineSeparator(), nodeCharacteristics, System.lineSeparator(),
                dataCharacteristics, System.lineSeparator());
    }
