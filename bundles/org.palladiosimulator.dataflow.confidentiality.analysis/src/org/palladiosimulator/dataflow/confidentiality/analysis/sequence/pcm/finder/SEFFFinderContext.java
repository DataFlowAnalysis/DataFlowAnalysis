...
public class SEFFFinderContext {
     ...
     */
    public SEFFFinderContext(Deque<AssemblyContext> context, Deque<AbstractPCMVertex<?>> callers, List<Parameter> parameter, List<DataStore> dataStores) {
    ...
    public void updateParameterForCallerReturning(AbstractPCMVertex<?> caller) {
    	if (caller instanceof CallingUserVertex) {
    		CallingUserVertex callingUserElement = (CallingUserVertex) caller;
    		...
    		this.parameter = ((CallingSEFFVertex) caller).getParameter();
    	}
    }
