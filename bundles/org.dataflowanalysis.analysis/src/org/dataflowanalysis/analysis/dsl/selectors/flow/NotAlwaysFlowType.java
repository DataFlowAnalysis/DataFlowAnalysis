...
public class NotAlwaysFlowType extends AbstractFlowType {
    private static final Logger logger = LoggerManager.getLogger(NotAlwaysFlowType.class);

    public NotAlwaysFlowType(AbstractSelector sourceSelector, AbstractSelector destinationSelector,
