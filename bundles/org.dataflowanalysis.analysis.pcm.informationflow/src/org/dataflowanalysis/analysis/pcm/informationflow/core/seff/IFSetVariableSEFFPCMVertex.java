 ...
 * {@link SetVariableAction}.
 */
public class IFSetVariableSEFFPCMVertex extends AbstractIFSEFFPCMVertex<SetVariableAction> {

    /**
     * As for a {@link SEFFPCMVertex} the vertex has an underlying SetVariableAction SEFF element which influences the
     * behavior through defined VariableCharacterisations. The vertex can have {@code previousElements} from which the
     * incoming DataFlowVariables are received. Furthermore, the vertex contains an {@link AssemblyContext}, passed
    ...
    protected List<VariableCharacterisation> extractVariableCharacterisations() {
        ...
        return element.getLocalVariableUsages_SetVariableAction()
                .stream()
