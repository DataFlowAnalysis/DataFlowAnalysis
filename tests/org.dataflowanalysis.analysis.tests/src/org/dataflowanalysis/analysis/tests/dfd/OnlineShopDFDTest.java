...
public class OnlineShopDFDTest {
  ...
  public void initAnalysis() {
    final var dataFlowDiagramPath =
        Paths.get("models", "OnlineShopDFD", "onlineshop.dataflowdiagram");
    final var dataDictionaryPath =
        Paths.get("models", "OnlineShopDFD", "onlineshop.datadictionary");
      ...
      var violations =
          analysis.queryDataFlow(
              ...
              it -> {
                ...
                return nodeLabels.contains("nonEU")
                    && dataLabels.contains("Personal")
  ...
  private List<String> retrieveNodeLabels(AbstractVertex<?> vertex) {
    return vertex.getAllNodeCharacteristics().stream()
