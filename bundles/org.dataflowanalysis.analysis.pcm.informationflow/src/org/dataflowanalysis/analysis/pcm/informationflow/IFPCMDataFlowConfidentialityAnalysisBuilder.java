...
public class IFPCMDataFlowConfidentialityAnalysisBuilder extends PCMDataFlowConfidentialityAnalysisBuilder {
	 ...
	 * 
	 * @param consider true, if the analysis should consider implicit flows. false,
	 *                 otherwise
	 ...
	 * @return the builder object of the analysis
	 */
	public IFPCMDataFlowConfidentialityAnalysisBuilder setExtractionStrategy(
	...
	@Override
	public IFPCMDataFlowConfidentialityAnalysisBuilder useNodeCharacteristicsModel(
