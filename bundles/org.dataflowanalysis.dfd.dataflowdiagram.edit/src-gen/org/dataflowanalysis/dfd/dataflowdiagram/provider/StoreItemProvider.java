...
/**
 * This is the item provider adapter for a {@link org.dataflowanalysis.dfd.dataflowdiagram.Store} object. <!--
...
public class StoreItemProvider extends NodeItemProvider {
    ...
    /**
     * This returns Store.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        String label = ((Store) object).getEntityName();
        return label == null || label.length() == 0 ? getString("_UI_Store_type") : getString("_UI_Store_type") + " " + label;
    }
