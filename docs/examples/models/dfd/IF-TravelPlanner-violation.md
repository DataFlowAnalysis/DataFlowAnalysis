...
<VPButton text="Open In Online Editor" href="https://editor.dataflowanalysis.org/?file=https://raw.githubusercontent.com/DataFlowAnalysis/DataFlowAnalysis/refs/heads/main/bundles/org.dataflowanalysis.examplemodels/scenarios/dfd/IF-TravelPlanner-violation/TravelPlanner-violation.json"></VPButton>
::: 
...
## 🚨 Violations
The error introduced in the case is that credit card data can bypass the declassification process, which implies a higher classification level. 
