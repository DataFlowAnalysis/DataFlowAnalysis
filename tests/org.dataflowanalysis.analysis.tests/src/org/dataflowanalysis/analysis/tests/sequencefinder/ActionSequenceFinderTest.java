...
public class ActionSequenceFinderTest extends BaseTest {
  ...
  public void testTravelPlannerCount() {
    ...
    assertEquals(
        ActionSequenceFinderPaths.travelPlannerPaths.size(),
        flowGraph.getPartialFlowGraphs().size(),
        String.format(
            "Expected two dataflow sequences, but found %s sequences",
            flowGraph.getPartialFlowGraphs().size()));
  ...
  public void testInternationalOnlineShopCount() {
    ...
    assertEquals(
        ActionSequenceFinderPaths.internationalOnlineShopPaths.size(),
        flowGraph.getPartialFlowGraphs().size(),
        String.format(
            "Expected two dataflow sequences, but found %s sequences",
            flowGraph.getPartialFlowGraphs().size()));
  ...
  public void testOnlineShopCount() {
    ...
    assertEquals(
        ActionSequenceFinderPaths.onlineShopPaths.size(),
        flowGraph.getPartialFlowGraphs().size(),
        String.format(
            "Expected two dataflow sequences, but found %s sequences",
            flowGraph.getPartialFlowGraphs().size()));
  ...
  public void testTravelPlannerPath() {
    ...
    for (int i = 0; i < ActionSequenceFinderPaths.travelPlannerPaths.size(); i++) {
      assertSequenceElements(
          flowGraph.getPartialFlowGraphs().get(i),
          ActionSequenceFinderPaths.travelPlannerPaths.get(i));
    }
  }
  ...
  public void testInternationalOnlineShopPath() {
    ...
    for (int i = 0; i < ActionSequenceFinderPaths.internationalOnlineShopPaths.size(); i++) {
      assertSequenceElements(
          flowGraph.getPartialFlowGraphs().get(i),
          ActionSequenceFinderPaths.internationalOnlineShopPaths.get(i));
    }
  }
  ...
  public void testOnlineShopPath() {
    ...
    for (int i = 0; i < ActionSequenceFinderPaths.onlineShopPaths.size(); i++) {
      assertSequenceElements(
          flowGraph.getPartialFlowGraphs().get(i),
          ActionSequenceFinderPaths.onlineShopPaths.get(i));
    }
  }
  ...
  public void testTravelPlannerSEFFContent() {
    PCMFlowGraph flowGraph = travelPlannerAnalysis.findFlowGraph();
    assertSEFFSequenceElementContent(
        flowGraph.getPartialFlowGraphs().get(0), 27, "ask airline to book flight");
  }
  ...
  public void testInternationalOnlineShopSEFFContent() {
    PCMFlowGraph flowGraph = internationalOnlineShopAnalysis.findFlowGraph();
    assertSEFFSequenceElementContent(
        flowGraph.getPartialFlowGraphs().get(0), 17, "DatabaseStoreUserData");
  }
  ...
  public void testOnlineShopSEFFContent() {
    PCMFlowGraph flowGraph = onlineShopAnalysis.findFlowGraph();
    assertSEFFSequenceElementContent(
        flowGraph.getPartialFlowGraphs().get(0), 3, "DatabaseLoadInventory");
  }
  ...
  public void testTravelPlannerUserContent() {
    PCMFlowGraph flowGraph = travelPlannerAnalysis.findFlowGraph();
    assertUserSequenceElementContent(
        flowGraph.getPartialFlowGraphs().get(0), 5, "look for flights");
  }
  ...
  public void testInternationalOnlineShopUserContent() {
    PCMFlowGraph flowGraph = internationalOnlineShopAnalysis.findFlowGraph();
    assertUserSequenceElementContent(
        flowGraph.getPartialFlowGraphs().get(0), 11, "BuyEntryLevelSystemCall");
  }
  ...
  public void testOnlineShopUserContent() {
    PCMFlowGraph flowGraph = onlineShopAnalysis.findFlowGraph();
    assertUserSequenceElementContent(
        flowGraph.getPartialFlowGraphs().get(0), 1, "ViewEntryLevelSystemCall");
  }
}
